...
public class MyRecipesSingleRecipeRecyclerAdapter extends RecyclerView.Adapter<MyRecipesSingleRecipeRecyclerAdapter.MainViewHolder>
{
    ...
    public MyRecipesSingleRecipeRecyclerAdapter(List<List<String>> list)
    {
        this.list = list;
    }
