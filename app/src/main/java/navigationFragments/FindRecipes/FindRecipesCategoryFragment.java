...
public class FindRecipesCategoryFragment extends Fragment
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        findRecipesAdapter.setOnItemClickListener(new FindRecipesAdapter.MainAdapterListener()
        {
            ...
            {
                Intent intent = new Intent(getContext(), FindRecipesSpecificRecipeActivity.class);
            ...
            db.collection("Recipes").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>()
            {
                ...
                public void onComplete(@NonNull Task<QuerySnapshot> task)
                {
                    ...
                    for (QueryDocumentSnapshot document : task.getResult())
                    {
                        ...
                        findRecipesModel.addItem(title, imageUrl);
