...
public class FindRecipesHorizontalRecyclerAdapter extends RecyclerView.Adapter<FindRecipesHorizontalRecyclerAdapter.MainViewHolder>
{
    ...
    public FindRecipesHorizontalRecyclerAdapter(List<String> list, List<Boolean> isSelected)//, List<String> url)
    {
        this.list = list;
