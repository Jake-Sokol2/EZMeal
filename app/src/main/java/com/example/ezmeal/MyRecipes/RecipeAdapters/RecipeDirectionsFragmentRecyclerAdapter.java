...
public class RecipeDirectionsFragmentRecyclerAdapter extends RecyclerView.Adapter<RecipeDirectionsFragmentRecyclerAdapter.MainViewHolder>
{
    ...
    public RecipeDirectionsFragmentRecyclerAdapter(List<String> list)
    {
        this.list = list;
    }
