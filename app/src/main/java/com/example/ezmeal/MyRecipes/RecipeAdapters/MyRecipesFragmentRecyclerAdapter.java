...
public class MyRecipesFragmentRecyclerAdapter extends RecyclerView.Adapter<MyRecipesFragmentRecyclerAdapter.MainViewHolder>
{
    ...
    public MyRecipesFragmentRecyclerAdapter(List<String> list, List<String> url)
    {
        this.list = list;
        this.url = url;
    }
