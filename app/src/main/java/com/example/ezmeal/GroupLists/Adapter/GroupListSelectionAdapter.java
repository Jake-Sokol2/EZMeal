...
public class GroupListSelectionAdapter extends RecyclerView.Adapter<GroupListSelectionAdapter.MainViewHolder>
{
    ...
    public GroupListSelectionAdapter(List<String> list, List<String> uriList)
    {
        this.list = list;
        this.uriList = uriList;
    }

    public GroupListSelectionAdapter(List<String> list)
    {
        this.list = list;
    }
